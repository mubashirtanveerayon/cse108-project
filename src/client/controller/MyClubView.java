...
public class MyClubView extends View {
...
//    }
    ...
    @FXML
    void onMaximumAgePressed(ActionEvent event) {
        clearContainer();
        addPlayers(search.getPlayersWithMaximum(club.name,AttributeKey.AGE));

    }

    @FXML
    void onMaximumHeightPressed(ActionEvent event) {
        clearContainer();
        addPlayers(search.getPlayersWithMaximum(club.name,AttributeKey.HEIGHT));
    }

    @FXML
    void onMaximumSalaryPressed(ActionEvent event) {
        clearContainer();
        addPlayers(search.getPlayersWithMaximum(club.name,AttributeKey.SALARY));
    }
...
//        requestSearch(list);
        ...
        ArrayList<Player>filtered = search.filterPlayers(club.clubAttribute,name);
    ...
    @FXML
    void onAllPlayersPressed(ActionEvent event) {
        clearContainer();
        addPlayers(search.filterPlayers(club.clubAttribute));
    }

    @FXML
    void onTotalYearlySalaryPressed(ActionEvent event) {
...
//    }
    ...
    public void addPlayer(Player player){
        ...
        try{
            ...
            controller.inMarketPlace=false;
            controller.actionButtonIcon.setGlyphName("MONETIZATION_ON");
